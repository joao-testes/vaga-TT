...
<main class="w-full mt-2 flex justify-center">
    @isset($message) <div class="min-w-full h-6 text-center bg-red-500 text-white">{{ $message  }}</div> @endisset
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="grid grid-cols-2 gap-4 mt-4  ml-6">
                                    <div>
                                        ...
                                        <p class="text-sm"><strong>Código Postal:</strong> {{ $user->address->zip }}</p>
                                    </div>
                                    <div>
                                        <!-- Exibição das coordenadas do endereço -->
                                        <h3 class="text-sm font-semibold mb-2">Coordenadas:</h3>
                                        <p class="text-sm">
                                            <strong>Latitude:</strong> {{ $user->address->coordinates->latitude }}</p>
                                        <p class="text-sm">
                                            <strong>Longitude:</strong> {{ $user->address->coordinates->longitude }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
